...
{
    cout << "This is a text based trivia game that tests your knowledge of Linux commands. You must match the command with its correct definition."
    "Points will be rewarded or deducted for correct and incorrect answers respectively. You may save and exit at any time." << endl;
}
